...
Além do operador simples de atribuição `=`, podemos simplificar algumas contruções de operações binárias utilizando operadores compostos.
...
Temos que usar _type casting_ antes da divisão, em um dos operadores:
